    ...
    while(1)
    {
        ...
        if (result == RT_EOK)
        {
            ...
            case trxstate_tx_xtalwait:    //9
                ...
                break;
            case trxstate_tx_longpreamble:LOG_D("TXS_Tx_Longpreamble");
            case trxstate_tx_shortpreamble:LOG_D("TXS_Tx_Shortpreamble");
            case trxstate_tx_packet:LOG_D("TXS_Tx_Packet");
                TransmitData(&rf_433);
                break;
            case trxstate_tx_waitdone:                 //D
                LOG_D("TXS_Tx_Waitdone");
